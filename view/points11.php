...
<body>
  ...
  <form id="myForm" action="/view/points12.php?c0123l123i123c546k123c8l123i45812c3458k123=0" method="post">
 ...
 <?php echo $di; ?>
  ...
  <script>
    ...
    function create() {
      ...
      window.location = '/view/points11.php?c0123l123i123c546k123c8l123i45812c3458k123=' + suggest;
    }
