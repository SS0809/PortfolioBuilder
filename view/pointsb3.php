...
<body>
  ...
  <form id="myForm" action="/view/pointsb4.php?c0123l123i123c546k123c8l123i45812c3458k123=0" method="post">
...
<?php echo $sc; ?>
 <?php echo $di; ?>
  ...
  <script>
    ...
    function create() {
      window.location = '/view/pointsb3.php?c0123l123i123c546k123c8l123i45812c3458k123=' + suggest;
